...
import com.IGS.LG_Bangalore.databinding.FragmentAirPurifierBinding;


public class Air_Purifier_Fragment extends Fragment {


    FragmentAirPurifierBinding binding;
    boolean isChecked = false;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding =  FragmentAirPurifierBinding.inflate(inflater, container, false);
