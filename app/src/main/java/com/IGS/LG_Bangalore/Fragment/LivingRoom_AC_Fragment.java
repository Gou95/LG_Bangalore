...
import com.IGS.LG_Bangalore.databinding.FragmentLivingRoomACBinding;


public class LivingRoom_AC_Fragment extends Fragment {



    FragmentLivingRoomACBinding binding;
    boolean isChecked = false;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding =  FragmentLivingRoomACBinding.inflate(inflater, container, false);
